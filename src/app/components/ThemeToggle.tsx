...
const ThemeToggle = () => {
    ...
    return(
        <div className="relative w-16 h-8 flex items-center bg-slate-400 dark:bg-grey-900 shadow cursor-pointer rounded-full size-4" onClick={()=> setDarkMode(!darkMode)}>
